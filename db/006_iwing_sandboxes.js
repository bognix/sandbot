...
db.serialize(() => {
  ...
  db.run(`INSERT INTO sandboxes VALUES('sandbox-qa01', '${channels.IWING_CHANNEL_ID}', '');`);
  db.run(`INSERT INTO sandboxes VALUES('sandbox-qa02', '${channels.IWING_CHANNEL_ID}', '');`);
  db.run(`INSERT INTO sandboxes VALUES('sandbox-qa03', '${channels.IWING_CHANNEL_ID}', '');`);
